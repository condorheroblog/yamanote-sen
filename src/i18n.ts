...
const resources = {
	en: {
		translation: {
			...
			offlineDescription: "Audio is streamed at runtime; offline caching is not available in this clone.",
			about: "About",
	...
	jp: {
		translation: {
			...
			offlineDescription: "このクローンでは音声はランタイムでストリーミングされ、オフラインキャッシュは利用できません。",
			about: "このサイトについて",
